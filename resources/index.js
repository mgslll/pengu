...
function changeLanguage() {
  ...
  if (language === "ar") {
      ...
      mainHeading.style.marginTop = "50px";
      ul.style.marginLeft = "350px";
      container.style.display = "flex";
container.style.justifyContent = "flex-start"; // اليمين مع RTL
      ...
      // باقي الترجمات الخاصة بالأقسام المختلفة ...
      logoImg.src = "resources/img/app_icon.png";

      // مثال على ترجمة قسم "About"
      // يمكنك إضافة باقي الترجمات كما هو في الكود الأصلي
  ...
  } else // الترجمات الفرنسية لتطبيق PenguChat
  if (language === 'fr') {
      document.getElementById("main-heading").innerHTML = "La plateforme tout-en-un pour la communication, le chat et le partage en temps réel en un seul clic";
      document.getElementById("menu-Our Services").textContent = "Nos Services";
      document.getElementById("menu-About Us").textContent = "À Propos";
      document.getElementById("menu-Partners").textContent = "Partenaires";
      document.getElementById("menu-Terms and Conditions").textContent = "Conditions Générales";
      ...
      document.getElementById("about-title").textContent = "Qu'est-ce que l'application PenguChat ?";
      document.getElementById("about-description").innerHTML =
          "<span class='highlight'>PenguChat</span> est une application tout-en-un conçue pour offrir une expérience de chat fluide et instantanée. Elle vous permet d'envoyer des messages, des photos, des vidéos et des fichiers facilement, avec une fonctionnalité de planification des messages pour s'assurer qu'ils arrivent au bon moment. Profitez également de la conversion de la voix en texte et découvrez une large gamme de produits et services. Rejoignez-nous et découvrez une communication rapide et intelligente qui rend chaque conversation plus efficace et productive !";
  
      document.getElementById("features-title").textContent = "Pourquoi notre application est le choix idéal pour vous ?";
      document.getElementById("features-description").textContent =
          "Que vous ayez besoin d'envoyer des messages instantanés, de partager des photos, des vidéos et des fichiers, ou même de planifier vos conversations, PenguChat vous propose des solutions innovantes et simples qui vous gardent connecté rapidement et facilement.";
  
      document.getElementById("card-1-title").textContent = "Chats instantanés et multimédias";
      document.getElementById("card-1-description").textContent = "Discutez instantanément et partagez des photos, vidéos et fichiers en toute simplicité avec vos amis et collègues.";
      document.getElementById("card-2-title").textContent = "Planification des messages";
      document.getElementById("card-2-description").textContent = "Planifiez vos messages à l'avance pour être sûr qu'ils arrivent au bon moment.";
      document.getElementById("card-3-title").textContent = "Conversion voix en texte";
      document.getElementById("card-3-description").textContent = "Convertissez rapidement les messages vocaux en texte, ce qui facilite le suivi des conversations en déplacement.";
  
      document.querySelector(".download-text").textContent = "Téléchargez l'application maintenant et profitez d'une communication innovante et unique avec PenguChat.";
      document.querySelector(".app-store").textContent = "Télécharger depuis Uptodown";
      document.querySelector(".google-play").textContent = "Télécharger PenguChat";
      ...
      var testimonials = document.querySelectorAll(".testimonial");
      if (testimonials.length >= 4) {
          testimonials[0].querySelector(".testimonial-text").textContent = '"La fonction de planification des messages sur PenguChat a rendu notre communication plus flexible."';
          testimonials[0].querySelector(".testimonial-author").textContent = "- Jean -";
  
          testimonials[1].querySelector(".testimonial-text").textContent = "J'aime pouvoir envoyer des vidéos sans limite de durée, ce qui rend le partage de mon contenu unique.";
          testimonials[1].querySelector(".testimonial-author").textContent = "- Sophie -";
  
          testimonials[2].querySelector(".testimonial-text").textContent = "L'interface intuitive de l'application rend la navigation à travers les produits extrêmement facile.";
          testimonials[2].querySelector(".testimonial-author").textContent = "- Pierre -";
  
          testimonials[3].querySelector(".testimonial-text").textContent = "PenguChat a amélioré la qualité et l'efficacité de notre communication quotidienne. Je le recommande vivement !";
          testimonials[3].querySelector(".testimonial-author").textContent = "- Camille -";
      }
      ...
      var motivationalQuotesPs = document.querySelectorAll(".motivational-quotes p");
      if (motivationalQuotesPs.length >= 2) {
          motivationalQuotesPs[0].textContent = '"Le succès est la somme de petits efforts répétés jour après jour."';
          motivationalQuotesPs[1].textContent = "Ne cherchez pas l'opportunité, créez-la.";
      }
      var socialMediaTitle = document.querySelector(".social-media h3");
      if (socialMediaTitle) {
...
// عند النقر على أزرار التمرير في الموقع
...
// فتح مودال الشروط والأحكام و"About Us" مع تعيين اللغة الافتراضية
...
function changeLanguageMobile() {
  ...
  var desktopSelect = document.getElementById("language-select");
...
// دوال فتح مودالات "About Us" و"Partners"
